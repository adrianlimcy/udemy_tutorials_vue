    ...
    <div class="signup-form">
      <form @submit.prevent="onSubmit">
        <div class="input" :class="{invalid: $v.email.$error}">
          ...
          <p v-if="!$v.email.required">This field is mandatory</p>
          <!-- <div>
            {{$v}}
          </div> -->
        </div>
        ...
        <div class="hobbies">
          ...
          <div class="hobby-list">
            ...
            <p v-if="!$v.hobbyInputs.minLen">You should have at least {{$v.hobbyInputs.$params.minLen.min}} hobby</p>
