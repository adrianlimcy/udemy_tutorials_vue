      ...
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
          ...
          <div class="form-group">
            ...
            type="password"
            id="password"
            class="form-control" v-model.lazy.trim.number="userData.password">
            <!-- .lazy means to wait till the input is finished and the user has moved to another field -->
            <!-- .trim means to remove front whitespaces | .number means to make it a number -->
            <!-- {{userData.password}} -->
          </div>
          <div class="form-group">
