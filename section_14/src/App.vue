    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <transition :name="alertAnimation" type="animation">
          <div class="alert alert-info" v-if="show">
            This depends on the select option
          </div>
        </transition>
        <transition :name="alertAnimation" type="animation" mode="out-in">
          <div class="alert alert-info" v-if="show" key="info">
            Transisting between elements
          </div>
          <div class="alert alert-warning" v-else key="warning">
            Transisting between elements - Warning
          </div>
        </transition>
        <hr>
        <button class="btn btn-primary" type="button" name="jsbutton" @click = "load = !load">Load / Remove Element</button>
        <br><br>
        <transition
